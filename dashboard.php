...
<header class="bg-white">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div class="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">Halo,
                    <span class="font-medium text-gray-900"><?php echo htmlspecialchars($username); ?></span>!
                </h1>
                <p class="mt-1.5 text-sm text-gray-500">Welcome back to rental</p>
            </div>
...
<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="grid grid-cols-2 row-gap-8 md:grid-cols-3 gap-8">
        <div class="text-center bg-white h-32 shadow-xl flex flex-col justify-center border">
            <h6 class="text-3xl font-bold text-blue-600"><?php echo $totalReturned; ?></h6>
            <p class="font-bold">Total yang sudah dikembalikan</p>
        </div>
        <div class="text-center bg-white h-32 shadow-xl flex flex-col justify-center border">
            <h6 class="text-3xl font-bold text-blue-600"><?php echo $totalRental; ?></h6>
            <p class="font-bold">Total Rental</p>
        </div>
        <div class="text-center bg-white h-32 shadow-xl flex flex-col justify-center border">
            <h6 class="text-3xl font-bold text-blue-600"><?php echo $totalCustomers; ?></h6>
...
<div class="w-full flex flex-col justify-center items-center h-24 px-8">
    <h2 class="text-5xl font-semibold">BENDI CAR RENTAL</h2>
